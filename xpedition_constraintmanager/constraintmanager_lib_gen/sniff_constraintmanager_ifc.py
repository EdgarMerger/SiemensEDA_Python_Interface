...
def generate_output() -> None:
    with open('./constraintmanager_orig.py', 'r') as in_file:
        with open('./constraintmanager_ifc.py', 'w') as out_file:
            process_file(in_file, out_file)

def copy_result():
    cmd: str = 'copy constraintmanager_ifc.py ../constraintmanager_ifc.py'
    result = subprocess.run(cmd, shell=True, capture_output=True, text=True)
    print(result)
    # cmd: str = 'copy constraintmanager_orig.py ../constraintmanager_orig.py'
    # result = subprocess.run(cmd, shell=True, capture_output=True, text=True)
    # print(result)
    # result = subprocess.run(shlex.split(cmd), shell=True, capture_output=True, text=True)
...
def add_type_hints_to_methods():
    ...
    with open('./constraintmanager_ifc.py', 'r') as file:
    ...
    with open('./constraintmanager_ifc.py', 'w') as file:
        file.writelines(updated_lines)                                    
def cleanup():
    cmd: str = 'del constraintmanager_orig.py'
    result = subprocess.run(cmd, shell=True, capture_output=True, text=True)
    print(result)
    
def add_future_annotations():
    # Define the file to be 
    filename = './constraintmanager_ifc.py'
