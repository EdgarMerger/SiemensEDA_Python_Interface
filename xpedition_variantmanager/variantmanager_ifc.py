...
class IMGCVariantMgrBlockDataModificationFilter(DispatchBaseClass):
	...
	InternalIndex: str # read_only
	Parent: str # read/write
	BlockData: str # write_only
	Variant: str # write_only
	VariantGroup: str # write_only
...
class IMGCVariantMgrConnectivity(DispatchBaseClass):
	...
	AccessLock: str # read/write
	AppName: str # read/write
	Blocks: str # IMGCVariantMgrBlocks; read_only
	ConnectivitySource: str # read_only
	ConnectivitySourceDate: str # read_only
	ConnectivitySourceType: str # read_only
	EquivalentBlockGroups: str # IMGCVariantMgrEquivalentBlockGroups; read_only
	InternalIndex: str # read_only
	Packages: str # IMGCVariantMgrPackages; read_only
	Parent: str # read/write
	ReusedBlocks: str # IMGCVariantMgrReusedBlocks; read_only
	RootBlock: str # IMGCVariantMgrBlock; read_only
	SnapshotName: str # read/write
	SymbolLocations: str # IMGCVariantMgrSymbolLocations; read_only
	Symbols: str # IMGCVariantMgrSymbols; read_only
...
class IMGCVariantMgrDocument(DispatchBaseClass):
	...
	AccessLock: str # read/write
	AliasPartNumberAttribute: str # read/write
	AttributePartName: str # read/write
	BPropModsUtility: str # IMGCVariantMgrBPropModsUtility; read_only
	CentralLibProps: str # read/write
	Connectivity: str # IMGCVariantMgrConnectivity; read_only
	Description: str # read/write
	FMVFunctions: str # IMGCVariantMgrFMVFunctions; read_only
	FXEGenerateSilkscreenFlag: str # read/write
	FlowID: str # read/write
	Groupings: str # IMGCVariantMgrGroupings; read_only
	ICDBOfflineMode: str # read/write
	InternalIndex: str # read_only
	LauncherAddress: str # read/write
	MessageMgr: str # IMGCVariantMgrMessageMgr; read_only
	ModificationCount: str # read/write
	ModificationCountEx: str # read/write
	ModificationCountLock: str # read/write
	Name: str # read/write
	NotesLayers: str # read_only
	PModsUtility: str # IMGCVariantMgrPModsUtility; read_only
	Parent: str # read/write
	ProjectFile: str # read/write
	ReadOnly: str # read_only
	RefDesName: str # read/write
	Reporter: str # IMGCVariantMgrReporter; read_only
	ReusedBlocksLibTopDir: str # read/write
	RootBlockName: str # read/write
	RootIF: str # IMGCVariantMgrDocument; read_only
	RunEventObserver: str # read/write
	SInfoRecsUtility: str # IMGCVariantMgrSInfoRecsUtility; read_only
	Settings: str # IMGCVariantMgrSettings; read_only
	ShowSymbolReplacements: str # read/write
	TemporaryDatabase: str # read/write
	UserName: str # read/write
	Utility: str # IMGCVariantMgrUtility; read_only
	VariantInfoRecsUtility: str # IMGCVariantMgrVariantInfoRecsUtility; read_only
	Variants: str # IMGCVariantMgrVariants; read_only
	VariantsDBFilename: str # read_only
	iCDBClientName: str # read_only
	variantsDBType: str # read_only
...
class IMGCVariantMgrEditor(DispatchBaseClass):
	...
	AccessLock: str # read/write
	EditorApplication: str # read_only
	InternalIndex: str # read_only
	ModificationCount: str # read/write
	ModificationCountEx: str # read/write
	ModificationCountLock: str # read/write
...
class IMGCVariantMgrEquivPartsSettings(DispatchBaseClass):
	...
	ModificationCountEx: str # read/write
	ModificationCountLock: str # read/write
	Parameters: str # IMGCVariantMgrParameters; read_only
	Parent: str # read/write
	RootIF: str # IMGCVariantMgrDocument; read_only
...
class IMGCVariantMgrEquivalentBlock(DispatchBaseClass):
	...
	AccessLock: str # read/write
	Block: str # IMGCVariantMgrBlock; read_only
	InternalIndex: str # read_only
	KeepInSyncWithTemplate: str # read/write
	Parent: str # read/write
...
class IMGCVariantMgrEquivalentBlockGroup(DispatchBaseClass):
	...
	AccessLock: str # read/write
	EquivalentBlocks: str # IMGCVariantMgrEquivalentBlocks; read_only
	InternalIndex: str # read_only
	Parent: str # read/write
	SchematicName: str # read_only
	TemplateBlock: str # read/write
...
class IMGCVariantMgrFMVFunction(DispatchBaseClass):
	...
	AccessLock: str # read/write
	Description: str # read/write
	FunctionType: str # read/write
	Hyperlink: str # read/write
	InternalIndex: str # read_only
	ModificationCount: str # read/write
	ModificationCountEx: str # read/write
	ModificationCountLock: str # read/write
	...
	Parent: str # read/write
	RootIF: str # IMGCVariantMgrDocument; read_only
	VariantAssignments: str # IMGCVariantMgrVariantAssignments; read_only
...
class IMGCVariantMgrFMVFunctionGroup(DispatchBaseClass):
	...
	AccessLock: str # read/write
	Description: str # read/write
	FMVFunctionAssignments: str # IMGCVariantMgrFMVFunctionAssignments; read_only
	InternalIndex: str # read_only
	ModificationCount: str # read/write
	ModificationCountEx: str # read/write
	ModificationCountLock: str # read/write
...
class IMGCVariantMgrFMVProperty(DispatchBaseClass):
	...
	ModificationCountLock: str # read/write
	Name: str # read/write
	NewAliasPartNumber: str # read/write
	NewCell: str # read/write
	NewPartNumber: str # read/write
	Parent: str # read/write
	ReuseAccessMode: str # read_only
	RootIF: str # IMGCVariantMgrDocument; read_only
	Symbol: str # IMGCVariantMgrSymbol; read_only
	MarkForCheckingConflicts: str # write_only
...
class IMGCVariantMgrGroupings(DispatchBaseClass):
	...
	AccessLock: str # read/write
	FMVFunctionGroups: str # IMGCVariantMgrFMVFunctionGroups; read_only
	InternalIndex: str # read_only
	ModificationCount: str # read/write
	ModificationCountEx: str # read/write
	ModificationCountLock: str # read/write
	Parent: str # read/write
	RootIF: str # IMGCVariantMgrDocument; read_only
	VariantGroups: str # IMGCVariantMgrVariantGroups; read_only
...
class IMGCVariantMgrOutputGenerator(DispatchBaseClass):
	...
	ErrorCode: str # read_only
	ErrorDescription: str # read_only
	MustGeneratebeforeView: str # read_only
	Parameters: str # IMGCVariantMgrParameters; read_only
...
class IMGCVariantMgrPModsUtility(DispatchBaseClass):
	...
	AccessLock: str # read/write
	BlockDataModifications: str # IMGCVariantMgrBlockDataModifications; read_only
	InternalIndex: str # read_only
	PackageModifications: str # IMGCVariantMgrPackageModifications; read_only
	Parent: str # read/write
...
class IMGCVariantMgrPackage(DispatchBaseClass):
	...
	AccessLock: str # read/write
	AliasPartNumber: str # read/write
	Cell: str # read/write
	FMVDriven: str # read/write
	ForwardPCBFlag: str # read/write
	HKPFlag: str # read/write
	IncludedInBOM: str # read/write
	InternalIndex: str # read_only
	IsLogicalOnlyPartModificationAllowed: str # read_only
	IsParentLogicalReusedBlock: str # read_only
	IsParentReusedBlock: str # read_only
	...
	ModificationCountLock: str # read/write
	Name: str # read/write
	PackageState: str # read_only
	Parent: str # read/write
	ParentDynamicReuseBlockName: str # read_only
	ParentPackage: str # read/write
	PartNumber: str # read/write
	RFComponent: str # read/write
	ReuseAccessMode: str # read_only
	RootIF: str # IMGCVariantMgrDocument; read_only
	SID: str # read/write
	SymbolPath: str # read_only
	Symbols: str # IMGCVariantMgrSymbols; read_only
	Type: str # read/write
	UnplaceFromNewVars: str # read/write
...
class IMGCVariantMgrPackageModification(DispatchBaseClass):
	...
	NewCell: str # read/write
	NewPartNumber: str # read/write
	Package: str # IMGCVariantMgrPackage; read_only
	Parent: str # read/write
	ReuseAccessMode: str # read_only
	RootIF: str # IMGCVariantMgrDocument; read_only
	Variant: str # read/write
...
class IMGCVariantMgrReporter(DispatchBaseClass):
	...
	AccessLock: str # read/write
	DataMatrix: str # IMGCVariantMgrReporterDataMatrix; read_only
	InternalIndex: str # read_only
	Parent: str # read/write
	Settings: str # IMGCVariantMgrReporterSettings; read_only
...
class IMGCVariantMgrReporterDataMatrix(DispatchBaseClass):
	...
	AccessLock: str # read/write
	InternalIndex: str # read_only
	NumColumns: str # read/write
	NumRows: str # read/write
	Parent: str # read/write
...
class IMGCVariantMgrReporterSettings(DispatchBaseClass):
	...
	AccessLock: str # read/write
	Date: str # read/write
	DifferencesOnly: str # read/write
	FieldDelimiter: str # read/write
	IncludeGroupName: str # read/write
	IncludeMasterPartNumber: str # read/write
	IncludeRefdesForFMVs: str # read/write
	InternalIndex: str # read_only
	OutputFile: str # read/write
	Parent: str # read/write
	ReportDataType: str # read/write
	Title: str # read/write
	UnplacedKW: str # read/write
...
class IMGCVariantMgrReuseSettings(DispatchBaseClass):
	...
	AccessLock: str # read/write
	AllowAccessOverwrite: str # read/write
	AllowMergeModeOverwrite: str # read/write
	DefaultAccessMode: str # read/write
	DefaultMergeMode: str # read/write
	InternalIndex: str # read_only
	ModificationCount: str # read/write
	ModificationCountEx: str # read/write
	ModificationCountLock: str # read/write
...
class IMGCVariantMgrReusedBlock(DispatchBaseClass):
	...
	AccessLock: str # read/write
	BlockData: str # IMGCVariantMgrBlockData; read_only
	Flattened: str # read/write
	InternalIndex: str # read_only
	LibraryName: str # read/write
	LogicalOnly: str # read/write
	LogicalOnlyPartModificationAllowed: str # read/write
	MergeMode: str # read/write
	MergeStatus: str # read_only
	ModificationCount: str # read/write
	ModificationCountEx: str # read/write
	ModificationCountLock: str # read/write
	Name: str # read/write
	Parent: str # read/write
	ReuseBlockDocument: str # IMGCVariantMgrDocument; read_only
	ReusedVariants: str # IMGCVariantMgrVariants; read_only
	RootIF: str # IMGCVariantMgrDocument; read_only
	VariantMappings: str # IMGCVariantMgrVariantMappings; read_only
	accessMode: str # read/write
...
class IMGCVariantMgrSInfoRecsUtility(DispatchBaseClass):
	...
	InternalIndex: str # read_only
	Parent: str # read/write
	RequiresMatrixCheck: str # read/write
	RequiresPackModRecalc: str # read_only
	RequiresRepackage: str # read_only
	SymbolInfoRecs: str # IMGCVariantMgrSymbolInfoRecs; read_only
...
class IMGCVariantMgrSettings(DispatchBaseClass):
	...
	ModificationCountLock: str # read/write
	Parent: str # read/write
	ReuseSettings: str # IMGCVariantMgrReuseSettings; read_only
	RootIF: str # IMGCVariantMgrDocument; read_only
	Statistics: str # IMGCVariantMgrStatistics; read_only
...
class IMGCVariantMgrSymbol(DispatchBaseClass):
	...
	ModificationCountLock: str # read/write
	Name: str # read/write
	NameAndPath: str # read_only
	Package: str # IMGCVariantMgrPackage; read_only
	Page: str # read_only
	PageIndex: str # read_only
	Parent: str # read/write
	ParentBlock: str # IMGCVariantMgrBlock; read_only
	ParentDynamicReuseBlockName: str # read_only
	ParentReusedBlock: str # IMGCVariantMgrReusedBlock; read_only
	PartNumber: str # read/write
	ReuseAccessMode: str # read_only
	ReusedBlock: str # IMGCVariantMgrReusedBlock; read_only
	RootIF: str # IMGCVariantMgrDocument; read_only
	SymbolLocation: str # IMGCVariantMgrSymbolLocation; read_only
...
class IMGCVariantMgrSymbolFilter(DispatchBaseClass):
	...
	AccessLock: str # read/write
	InternalIndex: str # read_only
	OnlyBorderSymbols: str # read/write
	Parent: str # read/write
...
class IMGCVariantMgrSymbolInfoRec(DispatchBaseClass):
	...
	AccessLock: str # read/write
	FMVProperties: str # IMGCVariantMgrFMVProperties; read_only
	InternalIndex: str # read_only
	ModificationCount: str # read/write
	ModificationCountEx: str # read/write
	ModificationCountLock: str # read/write
...
class IMGCVariantMgrUID(DispatchBaseClass):
	...
	objectID: str # read/write
	objectType: str # read/write
	userID: str # read/write
...
class IMGCVariantMgrUtility(DispatchBaseClass):
	...
	AccessLock: str # read/write
	Filters: str # IMGCVariantMgrFilters; read_only
	InternalIndex: str # read_only
	Parent: str # read/write
...
class IMGCVariantMgrVariant(DispatchBaseClass):
	...
	AccessLock: str # read/write
	BOMInclude: str # read/write
	Description: str # read/write
	FXEInclude: str # read/write
	FuncAttached: str # read/write
	Hyperlink: str # read/write
	InternalIndex: str # read_only
	ModificationCount: str # read/write
	ModificationCountEx: str # read/write