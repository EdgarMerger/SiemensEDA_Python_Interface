...
def copy_result():
    cmd: str = 'copy variantmanager_ifc.py ../variantmanager_ifc.py'
    result = subprocess.run(cmd, shell=True, capture_output=True, text=True)
    print(result)
    # cmd: str = 'copy variantmanager_orig.py ../variantmanager_orig.py'
    # result = subprocess.run(cmd, shell=True, capture_output=True, text=True)
    # print(result)
    # result = subprocess.run(shlex.split(cmd), shell=True, capture_output=True, text=True)
    # result = subprocess.run(['python', 'makepy.py', '-o', 'variantmanager_orig.py', '-v', 'MGCVariantMgr'], capture_output=True, text=True)
...
def add_type_hints_to_methods():
    ...
    with open('./variantmanager_ifc.py', 'r') as file:
    ...
    with open('./variantmanager_ifc.py', 'w') as file:
